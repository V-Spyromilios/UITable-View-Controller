...
var countries : [[CountryModel]] = [ [
	...
	CountryModel(name: "Ireland", description: descriptions.ireland, flagName: "Flag_of_Ireland", euMember: true),
	...
	CountryModel(name: "Malta", description: "Wonderfull Country", flagName: "Flag_of_Malta", euMember: true),
	
	CountryModel(name: "Poland", description: "Wonderfull Country", flagName: "Flag_of_Poland", euMember: true),
	
	CountryModel(name: "Portugal", description: "Wonderfull Country", flagName: "Flag_of_Portugal", euMember: true),
	
	CountryModel(name: "Romania", description: "Wonderfull Country", flagName: "Flag_of_Romania", euMember: true),
	
	CountryModel(name: "Slovakia", description: "Wonderfull Country", flagName: "Flag_of_Slovakia", euMember: true),
	
	CountryModel(name: "Slovenia", description: "Wonderfull Country", flagName: "Flag_of_Slovenia", euMember: true),
	
	CountryModel(name: "Spain", description: "Wonderfull Country", flagName: "Flag_of_Spain", euMember: true),
	
	CountryModel(name: "Sweden", description: "Wonderfull Country", flagName: "Flag_of_Sweden", euMember: true),
	
	CountryModel(name: "Croatia", description: "Wonderfull Country", flagName: "Flag_of_Croatia", euMember: true),
	
	CountryModel(name: "Czech Republic", description: "Wonderfull Country", flagName: "Flag_of_the_Czech_Republic", euMember: true),
	
	CountryModel(name: "Netherlands", description: "Wonderfull Country", flagName: "Flag_of_the_Netherlands", euMember: true),
],

[
	
	CountryModel(name: "Argentina", description: "Wonderfull Country", flagName: "Flag_of_Argentina", euMember: false),
	
	CountryModel(name: "Bolivia", description: "Wonderfull Country", flagName: "Flag_of_Bolivia", euMember: false),
	
	CountryModel(name: "Brazil", description: "Wonderfull Country", flagName: "Flag_of_Brazil", euMember: false),
	
	CountryModel(name: "Chile", description: "Wonderfull Country", flagName: "Flag_of_Chile", euMember: false),
	
	CountryModel(name: "Colombia", description: "Wonderfull Country", flagName: "Flag_of_Colombia", euMember: false),
	
	CountryModel(name: "Costa Rica", description: "Wonderfull Country", flagName: "Flag_of_Costa_Rica", euMember: false),
	
	CountryModel(name: "Equador", description: "Wonderfull Country", flagName: "Flag_of_Equador", euMember: false),
