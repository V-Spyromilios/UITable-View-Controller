//
//  OtherCountries+CoreDataProperties.swift
...
extension OtherCountries {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<OtherCountries> {
        return NSFetchRequest<OtherCountries>(entityName: "OtherCountries")
    }
...
extension OtherCountries : Identifiable {
